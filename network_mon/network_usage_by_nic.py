"""
Script to get the total upload and download usage along with the speed, by network interface card
...
def network_usage_by_nic() -> None:
    """Get total network usage by NIC"""
